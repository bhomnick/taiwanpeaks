...
! function (e) {
    e.fn.facebook_wall = function (s) {
        function a(e) {
            return s = e.replace(/</g, "&lt;").replace(/>/g, "&gt;"), s.replace(/((http|https|ftp):\/\/[\w?=&.\/-;#~%-]+(?![\w\s?&.\/;#~%"=-]*>))/g, '<a href="$1" target="_blank">$1</a>').replace(/(\r\n)|(\n\r)|\r|\n/g, "<br />");
            var s
        }
        ...
        if (void 0 !== s.id && void 0 !== s.access_token) {
            ...
            o.append('<div class="feeds-loading facebook-loading"></div>'), e.getJSON(n, function (l) {
                ...
                e(".facebook-loading", o).fadeOut(800, function () {
                    e(this).remove();
                    for (var a = 0; a < o.children("li").length; a++) "none" === s.effect ? o.children("li").eq(a).show() : "fade" === s.effect ? o.children("li").eq(a).delay(a * s.timeout).fadeIn(s.speed) : o.children("li").eq(a).delay(a * s.timeout).slideDown(s.speed, function () {
